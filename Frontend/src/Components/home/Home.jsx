...
function Home(){
  ...
  <img src="water.png" alt="Not available" className="img-fluid" />
        ...
        <div className="problem p-3 text-start">
          ...
          <p>Without real-time information on water quality, communities are at risk of consuming contaminated water, leading to health problems.</p>
          <h4>Lack of Affordable Solutions:</h4>
          <p>Existing water quality monitoring systems are expensive and not easily accessible to rural communities with limited resources.</p>
        </div>
      </div>
    </div>
  );
